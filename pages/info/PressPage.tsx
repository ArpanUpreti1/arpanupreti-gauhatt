...
import { Leaf, Mic, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#faf9f6] font-sans flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => navigate('/press')} className="text-sm font-medium text-primary-600 border-b-2 border-primary-500 transition-colors">Press</button>
            </div>
      ...
      <div className="w-full bg-primary-700 relative py-20 px-4 overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-2xl">
          <Mic size={48} className="mx-auto text-primary-300 mb-6" />
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-white mb-4">Press & Media</h1>
          <p className="text-primary-100 text-lg">Media resources and press releases.</p>
        </div>
      </div>
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 text-center">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">Media Kit Coming Soon</h2>
            <p className="text-lg text-gray-600 max-w-xl mx-auto mb-10">
                We are currently preparing our press kits, logos, and official media releases. For any urgent media inquiries or interview requests, please contact our PR team directly.
            </p>
            
            <div className="inline-flex items-center gap-3 bg-primary-50 text-primary-700 px-6 py-4 rounded-xl font-medium border border-primary-100">
                <Mail size={20} />
                <a href="mailto:press@gauhatt.com" className="hover:underline">press@gauhatt.com</a>
            </div>
        </div>
      </main>
