    ...
    <div className="min-h-screen bg-[#faf9f6] font-sans flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => navigate('/about')} className="text-sm font-medium text-primary-600 border-b-2 border-primary-500 transition-colors">About Us</button>
      ...
      <div className="w-full bg-primary-700 relative py-20 px-4 overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-2xl">
          ...
          <p className="text-primary-100 text-lg">Connecting you directly to the source of your food.</p>
        </div>
      </div>
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-16">
          <Users size={64} className="mx-auto text-primary-200 mb-6" />
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">Coming Soon</h2>
          <p className="text-lg text-gray-600 max-w-xl mx-auto mb-8">
            We are currently crafting our story. Gauhatt was founded with a simple mission: to empower local farmers and provide communities with the freshest, most sustainable produce possible. Stay tuned for the full journey!
          </p>
          <button onClick={() => navigate('/discover-products')} className="px-8 py-3 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 transition-colors shadow-md">
