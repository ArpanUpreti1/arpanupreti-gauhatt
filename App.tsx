...
import DeliveryInfo from './pages/dashboard/farmer/DeliveryInfo';
...
import DemandPrediction from './pages/dashboard/farmer/DemandPrediction';

// Consumer/Public Pages
import ProductListing from './pages/products/ProductListing';
import ProductDetailsPage from './pages/products/ProductDetailsPage';
import ProductsDiscoverPage from './pages/products/ProductsDiscoverPage';
      ...
      <Router>
        ...
        <div className="antialiased font-sans text-gray-900">
          <Routes>
            ...
            {/* Public Routes */}
            <Route path="/discover-products" element={<ProductsDiscoverPage />} />
